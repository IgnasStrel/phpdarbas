...
body {
     background-image: linear-gradient(-90deg, #7F5B23, #8B7030 100%) !important;
    height: 100vh;
}
...
<h1>69</h1>
<div><p>> <span>ERROR CODE</span>: "<i>{{ $error['code'] }}</i>"</p>
<p>> <span>ERROR DESCRIPTION</span>: "<i>{{ $error['message\'] }}</i>"</p>
